...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/astmonkey-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14413&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/astmonkey-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `astmonkey` can be installed with:

```
conda install astmonkey
```

It is possible to list all of the versions of `astmonkey` available on your platform with:
